  ...
  return (
    <>
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 px-6 py-3 flex justify-between items-center z-50 print:hidden">
        <Link href="/dashboard" className="text-slate-400 hover:text-indigo-600"><ICONS.Dashboard /></Link>
        <Link href="/receitas" className="text-slate-400 hover:text-indigo-600"><ICONS.Income /></Link>
        <Link href="/precificacao" className="text-slate-400 hover:text-indigo-600"><ICONS.Calculator /></Link>
        <Link href="/relatorios" className="text-slate-400 hover:text-indigo-600"><ICONS.FileText /></Link>
