        ...
        {(!userEmail || userEmail === 'pedrinhorodrigues.souza@gmail.com') && (
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl shadow-sm border border-orange-100">
                <div className="flex justify-between items-center">
                    <div>
                        <h2 className="text-lg font-bold text-orange-800">Carga Automática {userEmail ? '(Admin)' : '(Offline)'}</h2>
                        <p className="text-sm text-orange-700">
                            {userEmail ? 'Detectado usuário 01.' : 'Modo Offline Ativo.'} Disponível carga de histórico 2023-2025.
                        </p>
                    </div>
                    <button 
                        onClick={handleSeed}
